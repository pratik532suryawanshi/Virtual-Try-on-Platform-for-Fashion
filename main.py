...
listShirts = os.listdir(r"C:\Users\ADMIN\Downloads")  # replace with your actual path
#print(listShirts)
...
while True:
    ...
    if lmList: #if body is detected then import shirt
        ...
        lm11 = lmList[11][1:3]
        lm12 = lmList[12][1:3]
        imgShirt = cv2.imread(os.path.join(r"C:\Users\ADMIN\Downloads\Wear_image.jpg", listShirts[imageNumber]), cv2.IMREAD_UNCHANGED)
